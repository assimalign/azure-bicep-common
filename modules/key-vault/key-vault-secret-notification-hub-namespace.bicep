...
resource notificationHub 'Microsoft.NotificationHubs/namespaces/AuthorizationRules@2017-04-01' existing = {
...
resource notificationHubKeyVaultSecret 'Microsoft.KeyVault/vaults@2023-07-01' existing = {
  ...
  resource azNotificationNamespaceAuthPolicyConnectionStringSecret 'secrets' = {
    ...
    properties: {
      value: notificationHub.listKeys().primaryConnectionString
    }
  }
  resource notificationHubPrimaryKeySecret 'secrets' = {
    name: '${keyVaultSecretName}-primary-key'
    properties: {
      value: notificationHub.listKeys().primaryKey
    }
  }
}
