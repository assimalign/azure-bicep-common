...
resource azStorageAccountExistingResource 'Microsoft.Storage/storageAccounts@2022-05-01' existing = {
...
resource azStorageAccountKeyVaultSecretDeployment 'Microsoft.KeyVault/vaults@2023-07-01' existing = {
  ...
  resource azStorageAccountPrimaryKeySecret 'secrets' = {
