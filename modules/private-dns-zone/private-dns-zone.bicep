...
module azPrivateDnsARecordsDeployment 'private-dns-zone-a-record.bicep' = [for record in privateDnsZoneARecords: if (!empty(record)) {
...
module azPrivateDnsAaaaRecordsDeployment 'private-dns-zone-aaaa-record.bicep' = [for record in privateDnsZoneAaaaRecords: if (!empty(record)) {
...
module azPrivateDnsMxRecordsDeployment 'private-dns-zone-mx-record.bicep' = [for record in privateDnsZoneMxRecords: if (!empty(record)) {
...
module azPrivateDnsTxtRecordsDeployment 'private-dns-zone-txt-record.bicep' = [for record in privateDnsZoneTxtRecords: if (!empty(record)) {
...
module azPrivateDnsCnameRecordsDeployment 'private-dns-zone-cname-record.bicep' = [for record in privateDnsZoneCnameRecords: if (!empty(record)) {
...
module azPrivateDnsPtrRecordsDeployment 'private-dns-zone-ptr-record.bicep' = [for record in privateDnsZonePtrRecords: if (!empty(record)) {
...
module azPrivateDnsSrvRecordsDeployment 'private-dns-zone-svr-record.bicep' = [for record in privateDnsZoneSrvRecords: if (!empty(record)) {
...
module azPrivateDnsVirtualLinksDeployment 'private-dns-zone-link.bicep' = [for link in privateDnsZoneNetworkLinks: if (!empty(link)) {
