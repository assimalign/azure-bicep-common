...
resource azAseVirtualNetwork 'Microsoft.Network/virtualNetworks/subnets@2022-01-01' existing = {
...
resource azAseDeployment 'Microsoft.Web/hostingEnvironments@2022-03-01' = {
...
output appServiceEnvironment object = azAseDeployment
