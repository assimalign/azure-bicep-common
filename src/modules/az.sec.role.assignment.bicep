...
module azServiceBusRoleAssignment 'az.sec.role.assignment.service.bus.bicep' = if (resourceTypeAssigningRole == 'Microsoft.ServiceBus/Namespaces') {
...
module azServiceBusQueueRoleAssignment 'az.sec.role.assignment.service.bus.queue.bicep' = if (resourceTypeAssigningRole == 'Microsoft.ServiceBus/Namespaces/Queues') {
...
module azServiceBusTopicRoleAssignment 'az.sec.role.assignment.service.bus.topic.bicep' = if (resourceTypeAssigningRole == 'Microsoft.ServiceBus/Namespaces/Topics') {
...
module azCosmosRoleAssignment 'az.sec.role.assignment.cosmos.bicep' = if (resourceTypeAssigningRole == 'Microsoft.DocumentDB/DatabaseAccounts') {
...
module azSqlServerRoleAssignment 'az.sec.role.assignment.sql.server.bicep' = if (resourceTypeAssigningRole == 'Microsoft.Sql/Servers') {
...
module azSqlServerManagedRoleAssignment 'az.sec.role.assignment.sql.server.managed.bicep' = if (resourceTypeAssigningRole == 'Microsoft.Sql/ManagedInstances') {
...
module azMediaServicesRoleAssignment 'az.sec.role.assignment.media.services.bicep' = if (resourceTypeAssigningRole == 'Microsoft.Media/MediaServices') {
