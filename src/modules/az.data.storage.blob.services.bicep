...
module azStorageAccountBlobServiceContainerDeployment 'az.data.storage.blob.services.container.bicep' = [for container in storageAccountBlobServiceContainers: if(!empty(container)) {
...
module azStorageAccountBlobServicePrivateEndpointDeployment 'az.net.private.endpoint.bicep' = if(!empty(storageAccountBlobServicePrivateEndpoint)) {
