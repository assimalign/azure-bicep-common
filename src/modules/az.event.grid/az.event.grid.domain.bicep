...
module azEventGridPrivateEndpointDeployment '../az.private.endpoint/az.private.endpoint.bicep' = if(!empty(eventGridPrivateEndpoint)) {
...
module azEventGridRoleAssignment '../az.rbac/az.rbac.role.assignment.bicep' = [for roleAssignment in eventGridMsiRoleAssignments: if (eventGridMsiEnabled == true && !empty(eventGridMsiRoleAssignments)) {
