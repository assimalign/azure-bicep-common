...
// A collection of available roles to assign to service principals for Event Grid
...
resource azEventGridExistingResource 'Microsoft.EventGrid/domains@2021-06-01-preview' existing = if (resourceRoleAssignmentScope == 'Resource') {
