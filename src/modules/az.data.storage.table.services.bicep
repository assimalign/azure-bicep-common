...
module azStorageAccountTablesDeployment 'az.data.storage.table.services.tables.bicep' = [for table in storageAccountTables: if(!empty(table)) {
...
module azStorageTableServicePrivateEndpointDeployment 'az.net.private.endpoint.bicep' = if(!empty(storageAccountTableServicePrivateEndpoint)) {
